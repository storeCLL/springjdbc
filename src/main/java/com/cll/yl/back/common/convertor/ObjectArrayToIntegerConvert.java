...
/**
 * 描述信息:
 * 将对象数组转换成Integer数组转换器
 * @author CLL
 * @version 1.0
 * @date 2019/3/7 10:34
 */
public class ObjectArrayToIntegerConvert implements Convert<Object[], Integer[]> {
    ...
    public Integer[] convert(Object[] source) {
        ...
        Integer[] target = new Integer[sourceLength];
        for (int i = 0; i < sourceLength; i++) {
            try {
                ...
                logger.error("******对象数组转换成Integer类型数组抛出异常" + nfe.getMessage(), nfe);
                return null;
            }
        }
        return target;
